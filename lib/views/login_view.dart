...
class _LoginScreenState extends State<LoginScreen>
  ...
  Widget _buildGoogleButton() {
    return Obx(
      () => GestureDetector(
        onTap: _ctrl.isGoogleLoading.value ? null : _ctrl.loginWithGoogle,
        child: Container(
          width: double.infinity,
          ...
          child: Center(
            child: _ctrl.isGoogleLoading.value
                ? const SizedBox(
                    width: 20,
                    height: 20,
                    child: CircularProgressIndicator(
...
class AppColors {
  ...
  static const Color inputFocus = Color(0xFFD32F2F);

  static const List<Color> primaryGrad = [Color(0xFFD32F2F), Color(0xFFFF5722)];
  static const List<Color> logoGrad = [
    Color(0xFFD32F2F),
    Color(0xFF00796B),
    Color(0xFFFF5722),
  ];
  static const List<Color> tealOrange = [Color(0xFF00796B), Color(0xFFFF5722)];
}
      ...
      children: [
        ...
        AnimatedContainer(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(
              color: isFocused
                  ? AppColors.inputFocus.withOpacity(0.50)
                  : const Color(0xFF1A1A1A).withOpacity(0.10),
              width: isFocused ? 1.5 : 1,
            ),
            color: isFocused
                ? AppColors.inputFocus.withOpacity(0.04)
                : AppColors.inputBg,
            boxShadow: isFocused
                ? [
                    BoxShadow(
                      color: AppColors.inputFocus.withOpacity(0.12),
                      blurRadius: 12,
                      spreadRadius: 0,
                    ),
                  ]
